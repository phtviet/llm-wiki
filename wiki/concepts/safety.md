...
6. Political or religious ideological bias, which can skew a model toward supporting one ideology; studies (Feng et al., 2023; Motoki et al., 2023; Hartman et al., 2023) found models can carry political biases, with [[gpt-4|GPT-4]] shown as more left-leaning/libertarian and Llama more authoritarian-leaning (AIE p.171).

...
mostly Python APIs. Today there is increasing support for JavaScript APIs, including
LangChain.js, Transformers.js, OpenAI's Node library, and Vercel's AI SDK (AIE p.46).

While many AI engineers still come from traditional ML backgrounds, more are
increasingly coming from web development or full-stack backgrounds. An advantage
full-stack engineers have over traditional ML engineers is their ability to quickly
turn ideas into demos, get feedback, and iterate (AIE p.46).
